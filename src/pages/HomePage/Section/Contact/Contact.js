...
function Contact() {
    ...
    const handleSubmit = async (event) => {
        ...
        if (check === true) {
            let response = await createContact({ ...contactData });
                    ...
                    <div class="container d-flex justify-content-center align-items-center">
                        ...
                        <form>
                            ...
                            <div className="form-group position-relative">
                                ...
                                <input type="text"
                                    id="formName"
                                    className="form-control form-control-lg thick mb-3" placeholder="Name"
                                    name="username"
                            ...
                            <div className="form-group position-relative">
                                ...
                                <input type="email"
                                    id="formEmail"
                                    className="form-control form-control-lg thick mb-3" placeholder="E-mail"
                                    name='email'
                            ...
                            <div className="form-group message">
                                <textarea id="formMessage"
                                    ...
                                    onChange={(e) =>
                                        handleOnChangeInput(e.target.value, "message")
                                    }
                                >
                                </textarea>
                            </div>
                            ...
                            <div className="text-center">
                                <button className="btn btn-primary" tabIndex="-1" onClick={handleSubmit}>Send message</button>
                            </div>
                        </form>

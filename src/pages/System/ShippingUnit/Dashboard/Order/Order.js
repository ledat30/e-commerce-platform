                            ...
                            {filteredData.map((item, index) => {
                                ...
                                return (
                                    <tr key={index}>
                                        ...
                                        <td>{item.Order.OrderItems[0]?.Product_size_color.Product.product_name}</td>
                                        <td>{item.Order.OrderItems[0]?.Product_size_color.Color.name} , {item.Order.OrderItems[0]?.Product_size_color.Size.size_value}</td>

...
function User({ dataSummary }) {
    ...
    useEffect(() => {
        if (dataSummary && dataSummary.users) {
            setUsers(dataSummary.users);
            setTotalPages(Math.ceil(dataSummary.users.length / currentLimit));
        }
    ...
    return (
        <div className="table-category table">
            <div className="header-table-category header_table">
                <div className='table_manage'>Bảng quản lý người vận chuyển</div>
